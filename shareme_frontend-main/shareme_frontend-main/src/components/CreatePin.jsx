...
const CreatePin = ({user}) => {
  ...
  console.log(user);
  return (
    <div className='flec flex-col justify-center items-center mt-5 lg:h-4/5'>
      {fields && (
      ...
      <div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
          ...
          <div className='flex justify-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
            ...
            {!imageAsset ? (
              <label>
                <div className='flex flex-col items-center justify-center h-full'>
                  ...
                  <p className='mt-32 text-gray-400'>
                    Use high-quality JPG,SVG,PNG,GIF ot TIFF less than 20MB
                  </p>
                </div>
                <input
                type='file'
              ...
              <div className='relative h-full'>
                <img src={imageAsset?.url} alt='uploaded-pic' className=''/>
                <button 
                type='button'
                className='absolute botton-3 right-3 p-3 rounded-full bg-white text-xl cursor-pointer outline-none hover:shadow-md transition-al duration-500 ease-in-out'
        ...
        {user && (
          <div className='flex gap-2 my-2 item-center bg-white rounded-lg'>
            ...
            alt='user-profile'
            />
            <p className='font-bold'>{user.userName || user.username}</p>
          </div>
        )}
        <input
          type='text'
